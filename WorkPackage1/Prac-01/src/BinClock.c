...
int main(void){
	...
	for (;;){
		...
		//Write your logic here
		h = wiringPiI2CReadReg8(RTC, HOUR_REGISTER);
		m = wiringPiI2CReadReg8(RTC, MIN_REGISTER);
		s = wiringPiI2CReadReg8(RTC, SEC_REGISTER);
		
		hours = hexCompensation(h);
		mins = hexCompensation(m);
